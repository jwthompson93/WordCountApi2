...
public class WordCountFileApiTests {
    ...
    @Test
    void Test_FileUploaded_AnalysedSuccessfully_JsonResponse() throws Exception {
    ...
    @Test
    void Test_FileUploaded_AnalysedSuccessfully_TextResponse() throws Exception {
        MockMultipartFile file = new MockMultipartFile(
                "file", 
                "test.txt",
                MediaType.TEXT_PLAIN_VALUE,
